...
public class StuTestAdapter extends RecyclerView.Adapter<TestAdapter.ViewHolder> {
    ...
    public StuTestAdapter(Context mContext, ArrayList<Test> datas) {
    ...
    public TestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TestAdapter.ViewHolder(view, clickListener, longClickListener);
    }
    ...
    public void onBindViewHolder(TestAdapter.ViewHolder holder, int position) {
        ...
        holder.tvRightStatus.setText("开始");
