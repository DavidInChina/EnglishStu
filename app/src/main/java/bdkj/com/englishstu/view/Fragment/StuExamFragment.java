 ...
 * 学生考试
 */
public class StuExamFragment extends BaseFragment implements RecycleItemClickListener {
    ...
    public void initRecyclerView() {
        ...
        recyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                listData.clear();
                JsonEntity entity = StuDbUtils.testList(student.getId(), student.getClassIds().split(",")[1], "考试");
                if (entity.getCode() == 0) {
