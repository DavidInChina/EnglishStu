...
import bdkj.com.englishstu.common.adapter.StuNoticeAdapter;
 ...
 */
public class StuNoticeFragment extends BaseFragment implements RecycleItemClickListener {
    @BindView(R.id.recycler_view)
    XRecyclerView recyclerView;

    private List<Note> listData;
    private StuNoticeAdapter mAdapter;
    ...
    public void initRecyclerView() {
        ...
        recyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                listData.clear();
                JsonEntity entity = StuDbUtils.noteList(student.getId());
                if (entity.getCode() == 0) {
        ...
        mAdapter = new StuNoticeAdapter(mContext, (ArrayList<Note>) listData);
    ...
    public void onItemClick(View view, int postion) {
        ...
        if (note.getStatus() == 0) {
            StuDbUtils.noteRead(note.getRecordId());//读取当前公告
        }
